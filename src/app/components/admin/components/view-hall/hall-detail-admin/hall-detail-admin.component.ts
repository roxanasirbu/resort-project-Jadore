...
@Component({
  selector: 'app-hall-detail-admin',
  templateUrl: './hall-detail-admin.component.html',
  styleUrls: ['./hall-detail-admin.component.css']
})
export class HallDetailAdminComponent implements OnInit {
  controllerSrc: any;
  categories: any[] = [];
  itemId: any;
  currentUser: any;
