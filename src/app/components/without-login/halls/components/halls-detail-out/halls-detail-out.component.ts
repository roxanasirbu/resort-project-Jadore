...
@Component({
  selector: 'app-halls-detail-out',
  templateUrl: './halls-detail-out.component.html',
  styleUrls: ['./halls-detail-out.component.css']
})
export class HallsDetailOutComponent implements OnInit {
  controllerSrc: any;
  categories: any[] = [];
  itemId: any;
  currentUser: any;
  ...
  backToHalls(): void {
    this.routerNavigation.navigate(['/halls-out']);
  }
